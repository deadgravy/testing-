                        ...
                        <table class="table table-hover table-nowrap">
							...
							//Display respective tours
								...
								<tr>
                                    ...
                                    <td class="text-end">
                                        <a href="../view/tourDetails.jsp?tourID=<%=t.getId()%>" class="btn btn-sm btn-neutral">View</a>
                                    </td>
                                    <td class="text-end">
                                                 <a href="../view/EditForm.jsp?tourID=<%=t.getId()%>&title=<%=t.getTitle()%>&price=<%=t.getPrice()%>&slots=<%=t.getAvailableSlots()%>&briefDesc=<%=t.getBriefDesc()%>&detailedDesc=<%=t.getDetailedDesc()%>&category=<%= t.getCategoryID()%>" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
                                    <span class=" pe-2">
                                    ...
                                    <span>Edit</span>
                                           ...
                                           <a href="<%=request.getContextPath()%>/AdminDeleteServlet?tourID=<%=t.getId()%>" class="btn btn-sm btn-neutral">Delete</a>
                                    </td>
                                </tr>
