...
public class VerifyUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginid == null || password == null){
			response.sendRedirect("/ST0510-JAD-Practical/pract5/part4/login.jsp?errCode=invalidBody");
			return;
		}
        ...
        String connURL = "jdbc:mysql://localhost:3306/db1?user=root&password=San313916pang&serverTimezone=UTC";
        ...
        try {
	     ...
	     // rs.next() will return true if there is a result, false if none
	        if(rs.next()){
	        	...
	        	// Redirect
	        	response.sendRedirect("/ST0510-JAD-Practical/pract5/part4/displayMember.jsp");
	        	conn.close();
				return;
	        	...
	        	response.sendRedirect("/ST0510-JAD-Practical/pract5/part4/login.jsp?errCode=invalidLogin");
	        	conn.close();
				return;
	        }
